...
SECRET_KEY = 'django-insecure-$sed#+48j)pl_cp6mz@zy3xz8qxbbuaxnw8jql9+z12_p)0lh8'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # ⬅️ MUST be near the top
    'django.middleware.common.CommonMiddleware'
]
